package com.stellagosa.leetcode.leetcode3000_3999.leetcode_3342;

import java.util.PriorityQueue;

/**
 * @author Stellagosa
 * @description 到达最后一个房间的最少时间Ⅱ
 * @date 2025/5/8 14:07 星期四
 */
    ...
    public int minTimeToReach(int[][] moveTime) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int[] dir : dirs) {
                ...
                res[next_x][next_y] = Math.max(res[node.x][node.y], moveTime[next_x][next_y]) + (node.x + node.y) % 2 + 1;
